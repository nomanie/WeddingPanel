        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card m-b-30">
                    ...
                    <div class="card-body ">
                        <form action="{{route('admin.weddings.update',['wedding'=>$id])}}" id="action"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input value="{{$data['groom_first_name']}}" type="text" name="groom_first_name"
                                           id="groom_first_name" class="form-control"
                                           placeholder="Imie Pana młodego">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="groom_last_name">Nazwisko</label>
                                    <input value="{{$data['groom_last_name']}}" type="text" name="groom_last_name"
                                           id="groom_last_name" class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input value="{{$data['groom_phone_number']}}" type="number"
                                           name='groom_phone_number' id='groom_phone_number' class="form-control"
                                           placeholder="Numer telefonu Pana młodego">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="groom_email">Adres email</label>
                                    <input value="{{$data['groom_email']}}" type="email" name='groom_email'
                                           id='groom_email' class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input value="{{$data['bride_first_name']}}" type="text" name='bride_first_name'
                                           id='bride_first_name' class="form-control"
                                           placeholder="Imie Panny młodej">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="bride_last_name">Nazwisko</label>
                                    <input value="{{$data['bride_last_name']}}" type="text" name='bride_last_name'
                                           id='bride_last_name' class="form-control"
                                           placeholder="Nazwisko Panny młodej">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="bride_birthdate">Data urodzenia</label>
                                    <input value="{{$data['bride_birthdate']}}" type="date" name='bride_birthdate'
                                           id='bride_birthdate' class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input value="{{$data['bride_phone_number']}}" type="number"
                                           name='bride_phone_number' id='bride_phone_number' class="form-control"
                                           placeholder="Numer telefonu Panny młodej">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="bride_email">Adres email</label>
                                    <input value="{{$data['bride_email']}}" type="email" name='bride_email'
                                           id='bride_email' class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input value="{{$data['music_for_first_dance']}}" type="text"
                                           name='music_for_first_dance' id='music_for_first_dance' class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <div class="custom-control custom-checkbox">
                                        <input @if($data['music_for_first_dance_original']) checked="true"
                                               @endif type="checkbox" value="1" name='music_for_first_dance_original'
                                               id='music_for_first_dance_original' class="custom-control-input">
                                        <label class="custom-control-label" for="music_for_first_dance_original">Czy
                                            jest to orginalna wersja?</label>
                                    </div>
                                </div>

                                <div class="form-group col-md-2">
                                    <div class="custom-control custom-checkbox">
                                        <input @if($data['music_for_first_dance_full_length']) checked="true"
                                               @endif type="checkbox" value="1" name='music_for_first_dance_full_length'
                                               id='music_for_first_dance_full_length' class="custom-control-input">
                                        <label class="custom-control-label" for="music_for_first_dance_full_length">Cały
                                            utwór?</label>
                                    </div>
                                </div>
                                <div class="form-group col-md-6 d-flex">
                                    <div class="col-md-6">
                                        ...
                                        <input value="{{$data['music_for_first_dance_start']}}" type="text"
                                               name='music_for_first_dance_start' id='music_for_first_dance_start'
                                               class="form-control"
                                               placeholder="Minuta rozpoczęcia">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="music_for_first_dance_end">Do</label>
                                        <input value="{{$data['music_for_first_dance_end']}}" type="text"
                                               name='music_for_first_dance_end' id='music_for_first_dance_end'
                                               class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <div class="custom-control custom-checkbox">
                                        <input @if($data['thanks_to_parents']) checked="true" @endif type="checkbox"
                                               value="1" name='thanks_to_parents' id='thanks_to_parents'
                                               class="custom-control-input">
                                        <label class="custom-control-label" for="thanks_to_parents">Czy planowane są
                                            podziękowania?</label>
                                    </div>
                                </div>
                                <div class="form-group col-md-8">
                                    <label for="thanks_to_partens_description">Jeśli tak to w jakiej formie?</label>
                                    <textarea value="{{$data['thanks_to_partens_description']}}" rows="5"
                                              name='thanks_to_partens_description' id='thanks_to_partens_description'
                                              class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input value="{{$data['bride_parents_first_names']}}" type="text"
                                           name='bride_parents_first_names' id='bride_parents_first_names'
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input value="{{$data['groom_parents_first_names']}}" type="text"
                                           name='groom_parents_first_names' id='groom_parents_first_names'
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input value="{{$data['cake_time']}}" type="time" name='cake_time' id='cake_time'
                                           class="form-control">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input value="{{$data['meat_time']}}" type="time" name='meat_time' id='meat_time'
                                           class="form-control">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <div class="custom-control custom-checkbox">
                                        <input @if($data['services_music']) checked="true" @endif type="checkbox"
                                               value="1" name='services_music' id='services_music'
                                               class="custom-control-input">
                                ...
                                <div class="form-group col-md-4">
                                    <div class="custom-control custom-checkbox">
                                        <input @if($data['services_photo']) checked="true" @endif type="checkbox"
                                               value="1" name='services_photo' id='services_photo'
                                               class="custom-control-input">
                                ...
                                <div class="form-group col-md-4">
                                    <div class="custom-control custom-checkbox">
                                        <input @if($data['services_video']) checked="true" @endif  type="checkbox"
                                               value="1" name='services_video' id='services_video'
                                               class="custom-control-input">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <div class="custom-control custom-checkbox">
                                        <input @if($data['our_services_lights']) checked="true" @endif type="checkbox"
                                               value="1" name='our_services_lights' id='our_services_lights'
                                               class="custom-control-input">
                                ...
                                <div class="form-group col-md-4">
                                    <div class="custom-control custom-checkbox">
                                        <input @if($data['our_services_smoke']) checked="true" @endif type="checkbox"
                                               value="1" name='our_services_smoke' id='our_services_smoke'
                                               class="custom-control-input">
                                ...
                                <div class="form-group col-md-4">
                                    <div class="custom-control custom-checkbox">
                                        <input @if($data['our_services_photo_booth']) checked="true"
                                               @endif  type="checkbox" value="1" name='our_services_photo_booth'
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <div class="custom-control custom-checkbox">
                                        <input @if($data['our_services_love_sign']) checked="true"
                                               @endif  type="checkbox" value="1" name='our_services_love_sign'
                                ...
                                <div class="form-group col-md-4">
                                    <div class="custom-control custom-checkbox">
                                        <input @if($data['our_services_bartending']) checked="true"
                                               @endif  type="checkbox" value="1" name='our_services_bartending'
                                ...
                                <div class="form-group col-md-4">
                                    <div class="custom-control custom-checkbox">
                                        <input @if($data['our_services_live_instrumental']) checked="true"
                                               @endif  type="checkbox" value="1" name='our_services_live_instrumental'
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="special_wishes_photo_description">Specjalne życzenia dotyczące
                                        fotografii</label>
                                    <textarea type="text" name='special_wishes_photo_description'
                                              id='special_wishes_photo_description' class="form-control"
                                              placeholder="Specjalne życzenia dotyczące fotografii">{{$data['special_wishes_photo_description']}}</textarea>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="special_wishes_video_description">Specjalne życzenia dotyczące
                                        filmu</label>
                                    <textarea type="text" name='special_wishes_video_description'
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" value="{{$data['longer_movie']}}" name='longer_movie'
                                           id='longer_movie' class="form-control">
                                </div>
                                <div class="form-group col-md-8">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input value="{{$data['prepare_date']}}" type="time" name='prepare_date'
                                           id='prepare_date' class="form-control"
                                           placeholder="Wpisz datę przygotowań">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="bride_prepare_address">Adres przygotowań Pani Młodej</label>
                                    <input value="{{$data['bride_prepare_address']}}" type="text"
                                           name='bride_prepare_address' id='bride_prepare_address'
                                           class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input value="{{$data['restaurant_come']}}" type="time" name='restaurant_come'
                                           id='restaurant_come' class="form-control"
                                           placeholder="Wpisz datę przygotowań">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="prepare_address">Adres przygotowań Pana Młodego</label>
                                    <input value="{{$data['groom_prepare_address']}}" type="text"
                                           name='groom_prepare_address' id='groom_prepare_address'
                                           class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input value="{{$data['wedding_date']}}" type="time" name='wedding_date'
                                           id='wedding_date' class="form-control"
                                           placeholder="Wpisz godzinę">
                                </div>
                                <div class="form-group col-md-9">
                                    <label for="wedding_address">Adres ślubu</label>
                                    <input value="{{$data['wedding_address']}}" type="text" name='wedding_address'
                                           id='wedding_address' class="form-control"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input value="{{$data['party_date']}}" type="date" name='party_date' id='party_date'
                                           class="form-control"
                                           placeholder="Wpisz datę wesela" required>
                                </div>
                                <div class="form-group col-md-9">
                                    <label for="party_address">Adres wesela</label>
                                    <input value="{{$data['party_address']}}" type="text" name='party_address'
                                           id='party_address' class="form-control"
                        ...
                        <button class="btn btn-dark" id="restore">Przywróć formularz</button>
                        <script>
                            $("#restore").on('click', function () {
                                ...
                                $.ajax({
                                    ...
                                    success: function () {
                                        changeUrl("{{route('admin.weddings.index')}}");
                                    }
                                })
                            })
                        </script>
            ...
            <div id="form-errors-gallery" class="col-12"></div>
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="m-b-0">
                        Galeria
                    ...
                    <p class="m-b-0 text-muted">
                        Tutaj możesz wrzucić galerię ślubną.
                    </p>
                </div>
                <div class="card-body">

                    <form method="post" class="dropzone dz-clickable" id="sendFilesForm"
                          action="{{route('admin.weddings.archive.addImages',['id'=>$data['id']])}}">
                        @csrf
                        <div class="dz-message">
                            <h1 class="display-4">
                                <i class=" mdi mdi-progress-upload"></i>
                            </h1>
                            Przeciągnij pliki lub kliknij aby je wgrać..<br>
                            (Pliki wgrywają się automatycznie.)<br>
                        </div>
                    </form>

                    @if(\App\Models\Image::where('wedding',$data['id'])->count())
                        <button class="btn btn-dark mt-3 gallery-button" data-type="notification">Wyślij powiadomienia</button>
                   <button class="btn btn-dark mt-3 gallery-button" data-type="view">Podgląd galerii</button>
                    <button class="btn btn-dark mt-3 gallery-button" data-type="remove">Wyczyść galerię</button>@endif
                </div>
                <script>


                  // $("form.dropzone").dropzone({ url: "{{route('admin.weddings.archive.addImages',['id'=>$data['id']])}}" });

                    $('.gallery-button').on("click", function () {
                        let form = $('#sendFilesForm');
                        if ($(this).data('type') == 'notification')
                            $.ajax({
                                ...
                                success: function (data) {
                                    errors(data, $('#form-errors-gallery'));

                                },
                                error: function (data) {
                                    errors({'success':'Pomyślnie wysłano powiadomienia'},$('#form-errors-gallery'));
                                }
                            });
                        if ($(this).data('type') == 'view')
                            window.open("/galeria/"+"{{$data['token']}}", '_blank');
                            //$(location).attr('href',"/galeria/"+"{{$data['token']}}");
