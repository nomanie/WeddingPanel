                                ...
                                $(document).ready(function () {
                                    window.datatable = $('.table').DataTable({
                                        columns: [
                                            ...
                                            {data: 'party_date', "sClass": 'wedding_date'},
                                            {data: 'wedding_address', "sClass": 'wedding_address'},
                                            {data: 'dj', "sClass": 'dj'},
                                            {data: 'photo', "sClass": 'photo'},
                                            {data: 'operator', "sClass": 'operator'},
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                ...
                                                <a class="dropdown-item update" href="#">Przypisz pracownika</a>
