                        ...
                        <tr>
                            <td align="left" style="font-size:0px;padding:20px;word-break:break-word;">
                                <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#000000;">
                                    ...
                                    <hr>
                                    <h3>Zapis do galerii ślubnej</h3>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            Wasi goście mogą zapisać się do galerii ślubnej wpisująć swój adres email w formularzu znajdującym się pod tym linkiem:
                                            <br><a href="{{route('home.gallery.index',['token'=>$details['token']])}}">Formularz</a></b>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            Jeśli dane, które został wprowadzone są nieprawidłowe, lub uległy zmianie, prosimy o kontakt na asd@mail.pl. Prosimy umieścić w mailu id formularza
                                            <br>ID fomularza: <b>{{$details['id']}}</b>
                                        </div>
