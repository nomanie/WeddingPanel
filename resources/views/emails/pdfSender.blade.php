...
<html>
<head>
    <title>Formularz weselny: {{$details['id']}}</title>
</head>
                                            ...
                                            <tbody><tr>
                                                <td align="left" style="font-size:0px;padding:20px 20px 5px 20px;word-break:break-word;">
                                                    <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#000000;">
                                                        <h3 style="margin:0">Formularz weselny: {{$details['id']}}</h3>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td align="left" style="font-size:0px;padding:20px;word-break:break-word;">
                                                    <div style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:16px;font-weight:400;line-height:24px;text-align:left;color:#000000;">
                                                        ...
                                                        <div class="form-row">
                                                               ...
                                                               @if($details['dj']) <div style='display:inline-block;width:50%;'>Dj:{{\App\Models\User::find($details['dj'])->name}}</div> @endif()
                                                               @if($details['photo']) <div style='display:inline-block;width:50%;'>Fotograf: {{\App\Models\User::find($details['photo'])->name}}</div> @endif()
                                                               @if($details['operator']) <div style='display:inline-block;width:50%;'>Operator: {{\App\Models\User::find($details['operator'])->name}}</div> @endif()
                                                            </div>
                                                        </div>
                                                        <h3>Pan młody</h3>
                                                        <div class="form-row">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <div>Utwór na pierwszy taniec: {{$details['music_for_first_dance']}}</div>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                <div>Specjalne życzenia dotyczące fotografii:</div>
                                                                <div>{{$details['special_wishes_photo_description']}}</div>
                                                            </div>
                                                            <div class="form-group col-md-6">

                                                                <div>Dłuższa wersja filmu:</div>
                                                                <div>{{$details['longer_movie']}}</div>

                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <div>Specjalne życzenia dotyczące filmu, montażu:</div>
                                                                <div>{{$details['special_wishes_video_description']}}</div>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <div>Własny podkład muzyczny</div>
                                                                <div>{{$details['video_own_music']}}</div>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                <div>Godzina przygotowań: {{$details['prepare_date']}}</div>
                                                                <div>Adres przygotowań Pana młodego: {{$details['groom_prepare_address']}}</div>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <div>Planowana godzina przybycia na salę: {{$details['restaurant_come']}}</div>
                                                                <div>Adres przygotowań Panny młodej: {{$details['bride_prepare_address']}}</div>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <div>Godzina ślubu: {{$details['wedding_date']}}</div>
                                                                <div>Adres ślubu: {{$details['wedding_address']}}</div>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <div>Data wesela: {{$details['party_date']}}</div>
                                                                <div>Adres wesela: {{$details['party_address']}}</div>
                                                            </div>
                                                        </div>
                                                        <h3>Inne</h3>
                                                        <div class="form-row">
